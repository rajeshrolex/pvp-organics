...
const Products = () => {
    ...
    const products = {
        ...
        spices: [
            { name: 'Turmeric Powder', telugu: 'పసుపు', category: 'Spice', image: '/turmeric.jpg', quantities: ['1 kg', '500 g', '250 g', '100 g'] },
            { name: 'Red Chili Powder', telugu: 'మిరపకాయ పొడి', category: 'Spice', image: '/chili.jpg', quantities: ['1 kg', '500 g', '250 g', '100 g'] },
            { name: 'Coriander Seeds', telugu: 'ధనియాలు', category: 'Spice', image: '/coriander.jpg', quantities: ['1 kg', '500 g', '250 g', '100 g'] },
            { name: 'Cumin Seeds', telugu: 'జీలకర్ర', category: 'Spice', image: '/cumin.jpg', quantities: ['1 kg', '500 g', '250 g', '100 g'] },
            { name: 'Black Pepper', telugu: 'మిరియాలు', category: 'Spice', image: '/pepper.jpg', quantities: ['1 kg', '500 g', '250 g', '100 g'] },
            { name: 'Mustard Seeds', telugu: 'ఆవాలు', category: 'Spice', image: '/mustard-seeds.jpg', quantities: ['1 kg', '500 g', '250 g', '100 g'] },
            { name: 'Fenugreek Seeds', telugu: 'మెంతులు', category: 'Spice', image: '/Spices/Fenugreek Seeds.png', quantities: ['1 kg', '500 g', '250 g', '100 g'] },
            { name: 'Cardamom', telugu: 'ఏలకులు', category: 'Spice', image: '/Spices/Cardamom.png', quantities: ['1 kg', '500 g', '250 g', '100 g'] },
            { name: 'Cinnamon', telugu: 'దాల్చిన చెక్క', category: 'Spice', image: '/Spices/Cinnamon.png', quantities: ['1 kg', '500 g', '250 g', '100 g'] },
            { name: 'Cloves', telugu: 'లవంగాలు', category: 'Spice', image: '/Spices/Cloves.png', quantities: ['1 kg', '100 g', '50 g'] },
            { name: 'Star Anise', telugu: 'అనాస పువ్వు', category: 'Spice', image: '/Spices/StarAnise.png', quantities: ['1 kg', '100 g', '50 g'] },
            { name: 'Mace', telugu: 'జాపత్రి', category: 'Spice', image: '/Spices/Mace.png', quantities: ['1 kg', '50 g', '25 g'] },
            { name: 'Bay Leaves', telugu: 'బిర్యానీ ఆకు', category: 'Spice', image: '/Spices/BayLeaves.png', quantities: ['1 kg', '50 g', '25 g'] },
            { name: 'Kasthuri Methi', telugu: 'కస్తూరి మేతి', category: 'Spice', image: '/Spices/KasthuriMethi.png', quantities: ['1 kg', '100 g', '50 g'] },
        ],
    };
